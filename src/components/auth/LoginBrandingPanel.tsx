...
export function LoginBrandingPanel() {
  return (
    <div className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-[#4c1d95] via-[#6d28d9] to-[#7c3aed] p-10 text-white lg:flex lg:p-14">
      ...
      <blockquote className="relative z-10 max-w-lg font-serif text-4xl font-medium leading-snug lg:text-5xl">
